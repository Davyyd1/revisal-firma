...
Route::group(['middleware' => 'auth'], function(){
    ...
    Route::get('/add/company', [App\Http\Controllers\AddCompanyController::class, 'show_form_company'])->name('show-form-company');
    Route::post('/add/company', [App\Http\Controllers\AddCompanyController::class, 'add_company'])->name('add-company');
});
